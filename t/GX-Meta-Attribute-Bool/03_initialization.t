...
my $ATTRIBUTE_5 = GX::Meta::Attribute::Bool->new(
    class      => $CLASS_A,
    name       => 'attribute_5',
    initialize => 1
);

my $ATTRIBUTE_6 = GX::Meta::Attribute::Bool->new(
    class      => $CLASS_A,
    name       => 'attribute_6',
    default    => 1,
    initialize => 1
...
my $ATTRIBUTE_7 = GX::Meta::Attribute::Bool->new(
    class       => $CLASS_A,
    name        => 'attribute_7',
...
my $ATTRIBUTE_8 = GX::Meta::Attribute::Bool->new(
    class       => $CLASS_A,
    name        => 'attribute_8',
    initializer => sub { 1 },
    initialize  => 1
...
# attribute_8
{
    ...
    is_deeply( $object, { 'attribute_8' => 1 } );
...
# Initialize with data
{
    ...
    for my $attribute ( @ATTRIBUTES ) {
        ...
        {
            my $object = My::Class::A->new;
            $attribute->initialize_instance_slot( $object, { $attribute->name => 0 } );
            is_deeply( $object, { $attribute->slot_key => 0 } );
        }

        {
            my $object = My::Class::A->new;
            $attribute->initialize_instance_slot( $object, { $attribute->name => 1 } );
            is_deeply( $object, { $attribute->slot_key => 1 } );
        }

        {
            my $object = My::Class::A->new;
            $attribute->initialize_instance_slot( $object, { $attribute->name => undef } );
            is_deeply( $object, { $attribute->slot_key => undef } );
        }

        {
            my $object = My::Class::A->new;
            $attribute->initialize_instance_slot( $object, { $attribute->name => '' } );
            is_deeply( $object, { $attribute->slot_key => 0 } );
        }

        {
            my $object = My::Class::A->new;
            $attribute->initialize_instance_slot( $object, { $attribute->name => 'true' } );
            is_deeply( $object, { $attribute->slot_key => 1 } );
        }
